...
export const PythonLogo = (props: any) => (
  ...
  >
    <defs>
      <linearGradient id="pythonBlue" x1="10%" y1="10%" x2="90%" y2="90%">
        <stop stopColor="#5A9FD4" offset="0%"/>
        <stop stopColor="#306998" offset="100%"/>
      </linearGradient>
      <linearGradient id="pythonYellow" x1="10%" y1="10%" x2="90%" y2="90%">
        <stop stopColor="#FFE052" offset="0%"/>
        <stop stopColor="#FFC831" offset="100%"/>
      </linearGradient>
    ...
    <g filter="url(#shadow)">
      {/* Blue part of the snake - top half */}
      <path 
        d="M126.916,0.072c-64.832,0-60.784,28.115-60.784,28.115L66.2,57.315h62.568v8.828H41.631
        c0,0-41.486-4.705-41.486,60.711c0,65.417,36.21,63.097,36.21,63.097h21.61v-30.356c0,0-1.165-36.21,35.632-36.21h61.362
        c0,0,34.475,0.557,34.475-33.319V33.97C189.434,33.97,194.67,0.072,126.916,0.072z M92.802,19.66
        c11.12,0,11.13,11.13,0,11.13C81.682,30.79,81.672,19.66,92.802,19.66z"
        fill="url(#pythonBlue)"
      />
      {/* Yellow part of the snake - bottom half */}
      <path 
        d="M128.757,254.126c64.832,0,60.784-28.115,60.784-28.115l-0.072-29.127H127.6v-8.828h86.441
        c0,0,41.486,4.705,41.486-60.712c0-65.417-36.21-63.097-36.21-63.097h-21.61v30.356c0,0,1.165,36.21-35.632,36.21h-61.362
        c0,0-34.475-0.557-34.475,33.319v56.013C66.238,220.145,61.003,254.126,128.757,254.126z M162.871,234.54
        c-11.12,0-11.13-11.13,0-11.13C173.991,223.41,174.001,234.54,162.871,234.54L162.871,234.54z"
...
export const CPlusPlusLogo = (props: any) => (
  <svg viewBox="0 0 256 288" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" {...props}>
...
export const DjangoLogo = (props: any) => (
  <svg viewBox="0 0 256 326" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" {...props}>
    <g fill="#2BA977">
...
export const SecurityLogo = (props: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" fill="url(#grad1)" stroke="#770000" strokeWidth="1"/>
    <path d="M12 12.5c.8 0 1.5-.7 1.5-1.5s-.7-1.5-1.5-1.5-1.5.7-1.5 1.5.7 1.5 1.5 1.5z" fill="#fff"/>
    <path d="M12 13.5v3" stroke="#fff" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
